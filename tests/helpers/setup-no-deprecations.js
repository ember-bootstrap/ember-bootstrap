...
const ignoredDeprecations = [
  // @todo remove when we can land https://github.com/josemarluedke/ember-focus-trap/pull/34 here
  /Versions of modifier manager capabilities prior to 3\.22 have been deprecated/,
  /Usage of the Ember Global is deprecated./,
  /import .* directly from/,
  // @todo remove when we can land https://github.com/josemarluedke/ember-focus-trap/pull/35 here
  /Setting properties on objects generated by {{hash}} is deprecated/,
];
