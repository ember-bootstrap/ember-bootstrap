...
import { test, testBS3, testBS45, validationErrorClass } from '../../../helpers/bootstrap';
...
module('Integration | Component | bs-form/group', function (hooks) {
  ...
  testBS45('component has row class for horizontal layouts', async function (assert) {
  ...
  testBS45('does not set size class for BS4', async function (assert) {
    await render(hbs`<BsForm::Group @size="lg" />`);
