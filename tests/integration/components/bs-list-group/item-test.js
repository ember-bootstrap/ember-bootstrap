...
module('Integration | Component | bs-list-group/item', function (hooks) {
  ...
  <ListGroup.item class='second'>Second</ListGroup.item>
    ...
    assert
      ...
      .doesNotHaveAria(
        'disabled',
        'Second item does not have aria-attr disabled',
      );
  });
  ...
  <ListGroup.item class='second'>Second</ListGroup.item>
    ...
    assert
      ...
      .doesNotHaveAria(
        'current',
        'Second item does not have aria-attr current',
      );
  });
  ...
  <ListGroup.item class='second' @type='secondary'>Second</ListGroup.item>
    ...
    assert
      ...
      .hasClass(
        ...
        'First item has class list-group-item-primary',
      );
    ...
    assert
      ...
      .hasClass(
        ...
        'Second item has class list-group-item-secondary',
      );
  });
  ...
  <ListGroup.item class='second'>Second</ListGroup.item>
    ...
    assert
      ...
      .hasAttribute(
        'type',
        'button',
        'by default, type is set to "button" for <button>',
      );
    ...
    assert
      ...
      .doesNotHaveClass(
        ...
        'Second item does not have class list-group-item-action',
      );
  });

  (gte('3.25.0') ? test : skip)(
    'default attributes for custom HTML-tag (<button>) may be overridden',
