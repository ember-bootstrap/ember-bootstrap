...
import BsDropdownButton from './bs-dropdown/button.gjs';
import BsDropdownToggle from './bs-dropdown/toggle.gjs';
import BsDropdownMenu from './bs-dropdown/menu.gjs';
...
export default class Dropdown extends Component {
  ...
  get containerClass() {
    if (macroCondition(getOwnConfig().isBS4)) {
      // BS4: no special direction handling
    } else {
