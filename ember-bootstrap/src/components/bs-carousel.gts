...
export default class Carousel extends Component<CarouselSignature> {
   ...
   * @type array
   */
  get childSlides(): BsCarouselSlide[] {
    return this.children.filter(
      (view) => view instanceof (this.args.slideComponent ?? BsCarouselSlide),
    ) as unknown as BsCarouselSlide[];
  }
   ...
   *
   */
  get currentSlide(): BsCarouselSlide | undefined {
   ...
   * @private
   */
  get followingSlide(): BsCarouselSlide | undefined {
