...
import transitionEnd from '../utils/transition-end.ts';
import { getDestinationElement } from '../utils/dom.js';
import usesTransition from '../utils/decorators/uses-transition.ts';
import isFastBoot from '../utils/is-fastboot.ts';
import arg from '../utils/decorators/arg.ts';
import { cached, tracked } from '@glimmer/tracking';
import ModalHeader, { type HeaderSignature } from './bs-modal/header.gts';
import ModalDialog, {
  type DialogSignature,
  type ModalFullscreen,
  type ModalSize,
} from './bs-modal/dialog.gts';
import ModalBody, { type BodySignature } from './bs-modal/body.gts';
import ModalFooter, { type FooterSignature } from './bs-modal/footer.gts';
